...
text( c(0.4, 0.65, 0.4, 0.9, 0.9), c(6.7, 6.6, 6.3, 6.7, 6.3), c("Trees", "People", "Parked cars", "Ciclysts", "Moving cars"),  cex=1.4)#Complexity
...
text( c(0.4, 0.7, 0.4, 0.9, 0.9), c(6.7, 6.6, 6.3, 6.7, 6.3), c("Moving cars", "Trees", "Parked cars", "People", "Buildings"),  cex=1.4)#Complexity
text( c(0.4, 0.4, 0.9, 0.9), c(5.75, 5.3, 5.75, 5.3), c("Moving cars", "Trees", "People", "Street width"),  cex=1.4)#Human Scale
