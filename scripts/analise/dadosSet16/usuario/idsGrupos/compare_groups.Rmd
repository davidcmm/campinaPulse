...
max.diff.rank.ordered.logit.with.ties = function(stacked.data){
  ...
  solution = optim(seq(.01,.02, length.out = ncol(stacked.data)-1), ll.max.diff,  maxdiff.method  = "rlogit", gr = NULL, x = flat.data, method =  "BFGS", control = list(fnscale  = -1, maxit = 10, trace = FALSE), hessian = FALSE)#1000
...
```{r read}
for (file in c("../gavel/allPairwiseComparison-lam01-gam01.dat", "../gavel/allPairwiseComparison-lam1-gam01.dat", "../gavel/allPairwiseComparison-gamma5.dat", "../gavel/allPairwiseComparison-gamma20.dat", "../gavel/allPairwiseComparison-sim-lam01-gam01.dat", "../gavel/allPairwiseComparison-sim-lam01-gam20.dat")){
  print(paste(">>>>> Folder ", file))
