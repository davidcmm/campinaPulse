...
Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.26 a 1.9 entre ângulos do mesmo número**. Essas diferenças podem ser indicativos de variações de manutenção/qualidade de locais muito próximos. Por exemplo:
...
Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.4 a 1.6 no QScore entre ângulos do mesmo número**. Por exemplo:
...
**as maiores diferenças variam de 0.3 a 1.58 entre ângulos do mesmo número**. Por exemplo:
