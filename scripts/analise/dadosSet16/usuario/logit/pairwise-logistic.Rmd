...
agrad_notprof_mean <- 0.62605337
agrad_notprof_sd <- 0.21846091
agrad_prof_mean <- 0.718902866764 
agrad_prof_sd <- 0.15760134587
calcICFromMeanAndSD(agrad_notprof_mean,agrad_notprof_sd, agrad_prof_mean, agrad_prof_sd)

seg_notprof_mean <- 0.63881266
seg_notprof_sd <- 0.155730723699
seg_prof_mean <- 0.70449259231 
seg_prof_sd <- 0.153246472321
...
#Meu exemplo!
urbanQualities = data.frame(name=c("Enclosure", "Imageability", "Human Scale", "Coherence", "Transparency", "Tidiness", "Complexity", "Legibility", "Linkage", "Pleasantness", "Safety", "Trees", "Landscape"))
 mylist<-list(dimension=urbanQualities, links=data.frame(source=c(0, 1, 3, 4, 5, 11), target=c(9, 9, 9, 10, 10, 0), value=c(10, 5, 2, 7, 6, 1)) )

 result <- sankeyNetwork(Links = mylist$links, Nodes = mylist$dimension, Source = "source",
             Target = "target", Value = "value", NodeID = "name",
...
#text( rep(0.75, 7), 7:1, LETTERS[1:7] )
text( rep(0.7, 8), 8:1, c("HUMAN SCALE 21%", "COMPLEXITY 18%", "TIDINESS 15%", "ENCLOSURE 11%", "IMAGEABILITY 6%",  "LINKAGE 4.8%", "COHERENCE 4.2%",  "LEGIBILITY 2%") )
text( c(0.4, 0.4, 0.9, 0.9), c(7.75, 7.3, 7.75, 7.3), c("Street width", "Trees", "People", "Moving cars"),  cex=0.9)#Human Scale
text( c(0.4, 0.4, 0.4, 0.9, 0.9), c(6.75, 6.5, 6.3, 6.75, 6.3), c("Trees", "People", "Parked cars", "Ciclysts", "Moving cars"),  cex=0.9)#Complexity
text( 0.7, 5.6, c("Landscape"),  cex=0.9)#Tidiness
text( c(0.4, 0.9), 4.6, c("Trees", "Street width"),  cex=0.9)#Enclosure
text( c(0.4, 0.9), 3.6, c("Buildings ident", "People"),  cex=0.9)#Imageability
text( c(0.4, 0.9), 2.6, c("Street width", "Moving cars"),  cex=0.9)#Linkage
text( 0.7, 1.6, c("People"),  cex=0.9)#Coherence
text( 0.7, 0.6, c("Buildings ident"),  cex=0.9)#Legibility
...
#text( rep(0.75, 7), 7:1, LETTERS[1:7] )
text( rep(0.7, 7), 7:1, c("COMPLEXITY 36.9%", "HUMAN SCALE 30%", "LINKAGE 17.9%", "TIDINESS 12.6%", "ENCLOSURE 8.5%", "IMAGEABILITY 7.4%",  "COHERENCE 7.4%" ) )
text( c(0.4, 0.4, 0.4, 0.9, 0.9), c(6.75, 6.5, 6.3, 6.75, 6.3), c("Moving cars", "Parked cars", "Trees", "People", "Buildings"),  cex=0.9)#Complexity
text( c(0.4, 0.4, 0.9, 0.9), c(5.75, 5.3, 5.75, 5.3), c("Moving cars", "Trees", "People", "Street width"),  cex=0.9)#Human Scale
text( c(0.4, 0.9), 4.6, c("Moving cars", "Street width"),  cex=0.9)#Linkage
text( 0.7, 3.6, c("Landscape"),  cex=0.9)#Tidiness
text( c(0.4, 0.9), 2.6, c("Trees", "Street width"),  cex=0.9)#Enclosure
text( 0.7, 1.6, c("People"),  cex=0.9)#Imageability
text( 0.7, 0.6, c("People"),  cex=0.9)#Coherence
