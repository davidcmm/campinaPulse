...
```{r read}
pairwise <- raw_data = read_delim(
  "hom60_mul15//runmasculino_0_wodraw.dat",
  delim = "\t",
  col_types = cols(
    .default = col_double(),
...
for (folder in c("hom60_mul15/")){
    ...
    sink(paste(folder, "rank_comparisons.dat", sep=""))
...
#Iterating through rank_comparisons files to extract data for tau_agrad and tau_seg: "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/"
for (folder in c("hom60_mul15/")){
