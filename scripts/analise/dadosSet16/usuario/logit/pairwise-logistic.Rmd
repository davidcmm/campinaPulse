...
create_random_model_w_interact = function(the_data){
  return( glmer(choice ~ d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff + bair_cat +
          age_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) +
          gender:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) +
          inc_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) + (1|userID), data = agrad, family=binomial()) )
}
...
agrad_intercept <- gls(choice ~ 1, data = agrad, method = "ML")
agrad_intercept_user <- lme(as.integer(choice) ~ 1, data = agrad, random = ~1|userID, method="ML")
...
agrad_random_user <- lme(as.integer(choice) ~ d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff + bair_cat + age_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) + gender:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) + inc_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) , data = agrad, random = ~d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff + bair_cat|userID, method="ML")#~1|userID
summary(agrad_random_user)

seg_intercept <- gls(choice ~ 1, data = seg, method = "ML")
seg_intercept_user <- lme(as.integer(choice) ~ 1, data = agrad, random = ~1|userID, method="ML")
...
seg_random_user <- lme(as.integer(choice) ~ d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff + bair_cat + age_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) + gender:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) + inc_cat:(d_swidth + d_mvcars + d_pcars + d_trees + d_mvciclyst + d_lands + d_bid + d_bheig + d_dbuild + d_people + d_graff) , data = seg, random = ~1|userID, method="ML")
summary(seg_random_user)

#Creating only one level models
...
sankeyNetwork(Links = mylist$links, Nodes = mylist$dimension, Source = "source",
             Target = "target", Value = "value", NodeID = "name",
             units = "%", fontSize = 16, nodeWidth = 20)
