...
print("Random Effects not scaled")
print(summary(agrad_random_user_nscaled))

agrad_random_wo_user_nscaled <- create_random_model_wo_interact(agrad_nscaled, "")
print("Random Effects without user moderation not scaled")
print(summary(agrad_random_wo_user_nscaled))

vuongtest(agrad_random_user_nscaled, agrad_random_wo_user_nscaled)
icci(agrad_random_user_nscaled, agrad_random_wo_user_nscaled, conf.level = 0.95)
