...
for (current_file in masc_files){
   ...
   print(res)
   print(paste(">>>>>>>> Correlation Agrad: General Old x Removing Men Random", res$estimate))
   ...
   print(res)
   print(paste(">>>>>>>> Correlation Seg: General Old x Removing Men Random", res$estimate))
...
for (current_file in masc_files){
   ...
   res <- cor.test(merged$V3.y, merged$V3.x, method="kendall")
   print(res)
   print(paste(">>>>>>>> Correlation Agrad: Women Fixed x Men Random", res$estimate))
   print(paste(">>>>>>> Kendall distance Seg: Women Fixed x Men Random", normalizedKendallTauDistance2(merged_seg$V3.y, merged_seg$V3.x)))
   res <- cor.test(merged_seg$V3.y, merged_seg$V3.x, method="kendall")
   print(res)
   print(paste(">>>>>>>> Correlation Seg: Women Fixed x Men Random", res$estimate))
...
for (file in c("tau_men_agrad.dat", "tau_men_seg.dat")){
  ag_cor <- read.table(file, sep="")
  ag_cor$V2 <- as.factor(ag_cor$V2)
  values <- lapply(as.character(ag_cor$V2), function (x) as.double(str_split(x, pattern = "Random")[[1]][2]))
  new_values <- unlist(lapply(values, '[[', 1))
