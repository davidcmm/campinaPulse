...
for (file in c("../all100/all_elo_24.dat", "../all100/all_elo_10.dat", "../all100/all_elo_40.dat", "../all100/all_elo_20.dat")){
  ...
  diff1 <- length(setdiff(head(seg_orig, n=top_size)$V2, head(seg_elo, n=top_size)$V2))
  print(paste(">>>>>>> Set diff Top10_Seg: ", diff1))
  diff1 <- length(setdiff(tail(seg_orig, n=top_size)$V2, tail(seg_elo, n=top_size)$V2))
  print(paste(">>>>>>> Set diff Bottom10_Seg: ", diff1))
}  
...
for (file in c("../all100/all_ordenado_maxdiff_new.dat")){
  ...
  diff1 <- length(setdiff(head(seg_orig, n=top_size)$V2, head(seg_maxdiff, n=top_size)$V2))
  print(paste(">>>>>>> Set diff Top10_Seg: ", diff1))
  diff1 <- length(setdiff(tail(seg_orig, n=top_size)$V2, tail(seg_maxdiff, n=top_size)$V2))
  print(paste(">>>>>>> Set diff Bottom10_Seg: ", diff1))
}  
