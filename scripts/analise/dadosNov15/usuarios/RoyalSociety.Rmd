...
ggplot(filter(adjr2Data, question == "pleas"), aes(x=quantile, y=adjr2, colour=Groups)) + geom_line(size=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Adj. R2") + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25))
dev.off()

pdf("images/adjr2_Saf.pdf", width = w, height = h)
ggplot(filter(adjr2Data, question == "saf"), aes(x=quantile, y=adjr2, colour=Groups)) + geom_line(size=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Adj. R2") + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25))
dev.off()
...
#Testing 0.1 and 0.9 models for pleasantness!
...
regGroup1 <- lm(rank ~  street_wid + mov_cars + park_cars + mov_ciclyst + landscape + build_ident + trees + build_height + people + centro + catole + liberdade + diff_build + graffiti - 1, na.action = na.exclude, data = agradGeral)#Not normalized values
...
regGroup2 <- lm(rank ~  street_wid + mov_cars + park_cars + mov_ciclyst + landscape + build_ident + trees + build_height + people + centro + catole + liberdade + diff_build + graffiti - 1, na.action = na.exclude, data = segGeral)#Not normalized values
