...
#	python sorteia_grupos_geral.py feminino feminino_${i}.dat
	...
	python ../selectRunPerUsers.py ../run100/run.csv hom40_mul60/diff_masculino_${i}.dat hom40_mul60/diff_feminino_${i}.dat remove > hom40_mul60/runDiffMasFem_${i}.csv
	#python ../selectRunPerUsers.py ../run100/run.csv diff_feminino_${i}.dat remove > runDiffFeminino_${i}.csv

	python ../analisaQScore.py hom40_mul60/runDiffMasFem_${i}.csv 100 ../tasksDef.csv campina
	mv all.dat hom40_mul60/allDiffMasFem_${i}.dat
	#python ../analisaQScore.py runDiffFeminino_${i}.csv 100 ../tasksDef.csv campina
	#mv all.dat allDiffFeminino_${i}.dat

	sort -k 3 -r -o hom40_mul60/allDiffMasFem_${i}.dat hom40_mul60/allDiffMasFem_${i}.dat
