...
Abaixo temos, primeiramente, uma análise, para determinar o tamanho da amostra para 95% de confiança. Em seguida, temos a comparação do ranking geral com 29 usuários (primeira amostra analisada) com a amostra atual contendo 61 pessoas.
...
Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.29 a 1.88 entre ângulos do mesmo número**. Essas diferenças podem ser indicativos de variações de manutenção/qualidade de locais muito próximos. Por exemplo:
...
Para a Edesio percebemos **uma variação de aproximadamente 1.2** nas médias do QScore do número 1136 (terreno, pouco cuidada) e do número 1546 (casas mais novas, bem cuidadas). Esta diferença parece um indicativo de variação entre tipos, ou qualidades, de locais na rua. É importante perceber que, ao contrário da Inacio, a Edesio parece ter uma alternância maior entre locais bem e mal avaliados ao longo da rua.

Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.38 a 1.72 no QScore entre ângulos do mesmo número**. Por exemplo:
...
+ No número 284, ângulo 90 também pode ser um caso de preferências por fachadas;
...
Para a Manoel percebemos **uma variação de aproximadamente 0.4** nas médias do QScore do número 300 e do número 188. Esta diferença parece um indicativo de variações sutis de preferências dos usuários de acordo com as condições de manutenção na rua, lixo. 

Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar que, apesar das notas tipicamente baixas, 
**as maiores diferenças variam de 0.3 a 1.54 entre ângulos do mesmo número**. Por exemplo:

- No número 370, no ângulo 315 temos aprox. 0.6 a menos do melhor ponto da rua;
- No número 300, ângulo 315 temos aprox. 1.6 a menos  do melhor ponto da rua;
- No número 222, ângulo 22 temos 1.2 a menos do melhor ponto da rua;
