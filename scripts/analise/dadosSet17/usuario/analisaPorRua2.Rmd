...
surprise_unif_base_norm_fixed <- read.csv("./surprise/surprise_unif_base_norm_fixed_new.csv")
surprise_unif_baseMed_norm <- read.csv("./surprise/surprise_unif_baseMedian_norm_fixed.csv")
surprise_unif_base_norm_fixed_40 <- read.csv("./surprise/surprise_unif_base_norm_fixed_added_new.csv")
