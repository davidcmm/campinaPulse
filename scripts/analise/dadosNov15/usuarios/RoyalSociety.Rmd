...
test.kendallWithOppRankingsAndNonZeroFeature <- function(){
   ...
   checkTrue(result$debris == 12)
   checkTrue(result$pavement == 12)
   checkTrue(result$landscape == 12)
   checkTrue(result$propStreetWall == 12)
   checkTrue(result$propWind == 12)
   checkTrue(result$longSight == 12)
   checkTrue(result$propSkyAhead == 12)
   checkTrue(result$propSkyAcross == 12)
   checkTrue(result$buildHeight == 12)
   checkTrue(result$propActiveUse == 12)
...
test.kendallWithDiffRankingsAndNonZeroDiffFeature <- function(){
   ...
   checkTrue(result$debris == 4 * 2)
   checkTrue(result$pavement == 2 * 2)
   checkTrue(result$landscape == 2 * 2)
   checkTrue(result$propStreetWall == 2 * 2)
   checkTrue(result$propWind == 2 * 2)
   checkTrue(result$longSight == 2 * 2)
   checkTrue(result$propSkyAhead == 2 * 2)
   checkTrue(result$propSkyAcross == 2 * 2)
   checkTrue(result$buildHeight == 2 * 2)
   checkTrue(result$propActiveUse == 2 * 2)
   ...
   checkTrue(result$debrisN== 8 / 24)
   checkTrue(result$pavementN== 4 / 12)
   checkTrue(result$landscapeN== 4 / 12)
   checkTrue(result$propStreetWallN== 4 / 12)
   checkTrue(result$propWindN== 4 / 12)
   checkTrue(result$longSightN== 4 / 12)
   checkTrue(result$propSkyAheadN== 4 / 16)
   checkTrue(result$propSkyAcrossN== 4 / 12)
   checkTrue(result$buildHeightN== 4 / 12)
   checkTrue(result$propActiveUseN== 4 / 12)
}
...
#Reading table and formatting - Flavio coeff and sd
```{r, echo=FALSE, fig.show='asis', fig.width=10, fig.height=5}
ic <- function(mean, sd, n) { 
	return ( sd/sqrt(n)*qnorm(1-(0.05/2)) )#95% confidence interval, significance level of 0.05 (alpha)
}
