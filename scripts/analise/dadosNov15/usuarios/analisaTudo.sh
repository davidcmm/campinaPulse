...
python analisaQScore.py runMedia.csv 100 tasksDef.csv
mv all.dat allMedia.dat
python analisaQScore.py runBaixa.csv 100 tasksDef.csv
mv all.dat allBaixa.dat
python analisaQScore.py runFeminino.csv 100  tasksDef.csv
mv all.dat allFeminino.dat
python analisaQScore.py runMasculino.csv 100 tasksDef.csv
mv all.dat allMasculino.dat
python analisaQScore.py runMedio.csv 100 tasksDef.csv
mv all.dat allMedio.dat
python analisaQScore.py runPos.csv 100 tasksDef.csv
