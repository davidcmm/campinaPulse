...
regsubsetsAgrad.out <<- regsubsets(V3.Masculino - V3.Feminino ~ street_wid + sidewalk_wid + public_art + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + courtyards + major_landsc + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + prop_hist_build + outdoor_table + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = agrad.l, nbest = 1, nvmax = NULL, force.in = NULL, force.out = NULL, method = "exhaustive")
plot(regsubsetsAgrad.out, scale = "adjr2", main = "Adjusted R^2", )

print("##### Diferenca ranking Homem x Mulher - Pleasantness")
#regGeralAgrad <- lm(agrad.l$V3.Masculino - agrad.l$V3.Feminino ~ agrad.l$sidewalk_wid + agrad.l$mov_cars + agrad.l$pavement + agrad.l$landscape + agrad.l$courtyards + agrad.l$build_nrectan + agrad.l$prop_street_wall + agrad.l$graffiti + agrad.l$build_height + agrad.l$street_furnit + agrad.l$basic_col + agrad.l$accent_col + agrad.l$people + agrad.l$prop_active_use, na.action = na.exclude)
regGeralAgrad <- lm(rank - index ~ street_wid + sidewalk_wid + mov_cars + landscape + courtyards + build_nrectan + prop_sky_across + graffiti + build_height + accent_col + prop_active_use, na.action = na.exclude, data = agrad.l)
texreg(regGeralAgrad)
summary(regGeralAgrad)
...
#regGeralAgrad <- lm(agrad.l$V3.Jovem - agrad.l$V3.Adulto ~ agrad.l$street_wid + agrad.l$sidewalk_wid + agrad.l$public_art +  agrad.l$park_cars + agrad.l$mov_ciclyst + agrad.l$debris + agrad.l$landscape + agrad.l$major_landsc + agrad.l$build_ident + agrad.l$build_nrectan + agrad.l$prop_street_wall + agrad.l$prop_wind + agrad.l$prop_sky_ahead + agrad.l$prop_sky_across + agrad.l$trees + agrad.l$build_height + agrad.l$diff_build + agrad.l$prop_hist_build +   agrad.l$lights + agrad.l$accent_col + agrad.l$people, na.action = na.exclude)
regGeralAgrad <- lm(diff ~ park_cars + landscape + build_ident + build_nrectan + long_sight + prop_sky_across + graffiti + diff_build + basic_col, na.action = na.exclude, data = agrad.l)
texreg(regGeralAgrad)
summary(regGeralAgrad)
...
#regGeralAgrad <- lm(agrad.l$V3.Casado - agrad.l$V3.Solteiro ~ agrad.l$street_wid + agrad.l$sidewalk_wid + agrad.l$park_cars + agrad.l$mov_ciclyst + agrad.l$pavement + agrad.l$courtyards + agrad.l$build_ident + agrad.l$build_nrectan + agrad.l$prop_street_wall + agrad.l$prop_sky_ahead + agrad.l$prop_sky_across + agrad.l$graffiti + agrad.l$build_height + agrad.l$build_diff_ages + agrad.l$diff_build + agrad.l$street_furnit  + agrad.l$basic_col + agrad.l$lights + agrad.l$people, na.action = na.exclude)
regGeralAgrad <- lm(diff ~ street_wid + park_cars + landscape + build_ident + build_nrectan + prop_street_wall + long_sight + prop_sky_ahead + graffiti + build_height + build_diff_ages + diff_build + street_furnit  + basic_col + lights + people, na.action = na.exclude, data = agrad.l)
texreg(regGeralAgrad)
summary(regGeralAgrad)
...
#regGeralAgrad <- lm(agrad.l$V3.Baixa - agrad.l$V3.Media ~ agrad.l$mov_ciclyst + agrad.l$build_ident + agrad.l$build_nrectan + agrad.l$prop_street_wall + agrad.l$prop_wind + agrad.l$long_sight + agrad.l$prop_sky_ahead + agrad.l$small_planters + agrad.l$build_diff_ages + agrad.l$diff_build  + agrad.l$outdoor_table + agrad.l$accent_col + agrad.l$people, na.action = na.exclude)
regGeralAgrad <- lm(diff ~ park_cars + mov_ciclyst + debris + pavement + landscape + build_nrectan + long_sight + prop_sky_ahead + prop_sky_across + build_diff_ages + diff_build + outdoor_table + accent_col + people, na.action = na.exclude, data = agrad.l)
texreg(regGeralAgrad)
summary(regGeralAgrad)
...
#regGeralAgrad <- lm(seg.l$V3.Masculino - seg.l$V3.Feminino ~ seg.l$street_wid + seg.l$mov_cars + seg.l$park_cars + seg.l$mov_ciclyst + seg.l$debris + seg.l$pavement + seg.l$courtyards + seg.l$major_landsc + seg.l$build_ident + seg.l$build_nrectan + seg.l$prop_street_wall + seg.l$prop_wind + seg.l$long_sight + seg.l$prop_sky_ahead + seg.l$prop_sky_across + seg.l$small_planters + seg.l$build_height + seg.l$diff_build + seg.l$prop_hist_build + seg.l$street_furnit +  seg.l$accent_col + seg.l$people, na.action = na.exclude)
print("##### Diferenca ranking Homem x Mulher - Safety")
regGeralSeg <- lm(diff ~ street_wid + public_art + mov_cars + park_cars + debris + courtyards + build_ident + build_nrectan + prop_street_wall + prop_wind + prop_sky_across + small_planters + build_height + build_diff_ages + prop_hist_build + accent_col + people, na.action = na.exclude, data = seg.l)
texreg(regGeralSeg)
summary(regGeralSeg)
...
#regGeralAgrad <- lm(seg.l$V3.Jovem - seg.l$V3.Adulto ~ seg.l$street_wid + seg.l$sidewalk_wid + seg.l$public_art +  seg.l$park_cars + seg.l$mov_ciclyst + seg.l$debris + seg.l$landscape + seg.l$major_landsc + seg.l$build_ident + seg.l$build_nrectan + seg.l$prop_street_wall + seg.l$prop_wind + seg.l$prop_sky_ahead + seg.l$prop_sky_across + seg.l$trees + seg.l$build_height + seg.l$diff_build + seg.l$prop_hist_build +   seg.l$lights + seg.l$accent_col + seg.l$people, na.action = na.exclude)
regGeralSeg <- lm(diff ~ street_wid + mov_cars + debris + pavement + landscape + courtyards + major_landsc + long_sight + graffiti + build_diff_ages + diff_build + lights, na.action = na.exclude, data = seg.l)
texreg(regGeralSeg)
summary(regGeralSeg)
...
#regGeralSeg <- lm(seg.l$V3.Casado - seg.l$V3.Solteiro ~ seg.l$public_art + seg.l$mov_cars + seg.l$debris + seg.l$courtyards + seg.l$major_landsc + seg.l$prop_street_wall + seg.l$prop_wind + seg.l$prop_sky_across + seg.l$prop_hist_build + seg.l$basic_col + seg.l$prop_active_use, na.action = na.exclude)
regGeralSeg <- lm(diff ~ public_art + mov_cars + landscape + courtyards + major_landsc + prop_sky_across + prop_hist_build + basic_col, na.action = na.exclude, data = seg.l)
texreg(regGeralSeg)
summary(regGeralSeg)
...
#regGeralSeg <- lm(seg.l$V3.Baixa - seg.l$V3.Media ~ seg.l$sidewalk_wid + seg.l$mov_cars + seg.l$park_cars + seg.l$debris + seg.l$landscape + seg.l$courtyards + seg.l$prop_street_wall + seg.l$prop_wind + seg.l$long_sight + seg.l$trees + seg.l$small_planters + seg.l$build_height + seg.l$prop_hist_build + seg.l$basic_col + seg.l$people + seg.l$prop_active_use, na.action = na.exclude)
regGeralSeg <- lm(diff ~ park_cars + debris + landscape + build_nrectan + prop_street_wall + build_diff_ages + prop_hist_build + street_furnit + lights + accent_col + prop_active_use, na.action = na.exclude, data = seg.l)
texreg(regGeralSeg)
summary(regGeralSeg)
```
