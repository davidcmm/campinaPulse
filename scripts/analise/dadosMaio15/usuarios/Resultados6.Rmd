...
ggplot(novosDados, aes(y=agradavel, x=Seguro, colour=bairro))+geom_point()+xlab("QScore Seguro")+ylab("QScore Agradável")+geom_abline(intercept=0, colour="red")+theme_bw()+theme(axis.text=element_text(size=16), axis.title=element_text(size=16), legend.text = element_text(size=16), legend.title=element_text(size=16))
```
