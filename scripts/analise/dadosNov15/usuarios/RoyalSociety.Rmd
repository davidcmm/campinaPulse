...
seg.l$mode[seg.l$diff <= -35] <- "baixa"
seg.l$mode[seg.l$diff >= 35] <- "media"
seg.l$mode[seg.l$diff > -35 & seg.l$diff < 35] <- "zero"
...
seg.l$mode = relevel(seg.l$mode, ref = "zero")
...
ggplot(seg.l, aes(x=diff)) + geom_density(adjust = .5) + theme_bw() + theme(panel.grid.major = element_line(colour = "blue")) + scale_x_discrete(breaks=seq(-50, 50, 10))#-35/30 to define bump?
