...
ggplot(dataToPlot, aes(x=value, fill=variable)) +
     geom_histogram(alpha=.5, position="identity") + xlab("RGB values") + ylab("Absolute Frequency")
...
currentData$shap = factor(currentData$shap)
ggplot(data=currentData, aes(x=quantile, y=value, colour=feature, shape=feature)) + scale_shape_manual(values=1:nlevels(quantileData$feature)) + geom_point(size=5) + theme_bw() + ylim(-180, 180) + xlab("Quantiles") + ylab("Coefficients") + theme(legend.text=element_text(size=15))

ggplot(data=currentData, aes(x=quantile, y=value, colour=feature)) + geom_point(size=5, aes(shape=shap)) + scale_shape_manual(values=1:nlevels(quantileData$shap)) + theme_bw() + ylim(-180, 180) + xlab("Quantiles") + ylab("Coefficients") + theme(legend.text=element_text(size=15))#Shape across plots?
