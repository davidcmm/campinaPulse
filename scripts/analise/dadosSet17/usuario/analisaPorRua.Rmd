...
Analisando as imagens de cada ângulo em cada ponto da rua, pode-se observar **diferenças de 1 ou mais pontos no QScore entre ângulos do mesmo número**. Por exemplo:
- no número 54, as variações para os ângulos 203 e 293
- no número 120 a baixa nota do ângulo 203
- no número 239 existe uma maior homogeneidade
- no número 360 os números 90 e 203 
- no número 500 também temos uma maior homogeneidade
...
Para a Edesio percebemos **uma variação de aproximadamente 1.4** nas médias do QScore do número 1136 () e do número 1546 (). Esta diferença parece um indicativo de variação entre tipos, ou qualidades, de locais na rua.
