...
for group in "media-baixa"; do #"jovem-adulto" "media-baixa" ; do #"masculino-feminino" "jovem-adulto" "media-baixa"

	group1=`echo $group | cut -d \- -f 1`
	group2=`echo $group | cut -d \- -f 2`

	for desb in "60-15" "60-40" "15-60" "40-60" "60-60" ; do #"60-15" "60-40" "15-60" "40-60" ; do
		...
		for i in {0..99}; do 
			...
			python ../analisaQScore.py run${name1}_${i}.csv 100 ../tasksDef.csv campina
			mv all.dat all${name1}_${i}.dat
			python ../analisaQScore.py run${name2}_${i}.csv 100 ../tasksDef.csv campina
