...
geraValores <- function(lista, question, desvios){
   desvio = sd(lista, na.rm = TRUE)
   #Apenas 1 valor
...
groupedData1 <- summarise(by_image,
  count = n(),
  q1 = geraValores(question1, "1", desvios),
  #sdq1 = sd(question1, na.rm = TRUE),
  q2_left = geraValores(question2__left_side, "2l", desvios),
  #sdq2_left = sd(question2__left_side, na.rm = TRUE),
  q2_right = geraValores(question2__right_side, "2r", desvios),
  #sdq2_right = sd(question2__right_side, na.rm = TRUE),
  q3 = geraValores(question3, "3", desvios)
  #sdq3 = sd(question3, na.rm = TRUE) 
  )
...
groupedData3 <- summarise(by_image,
  count = n(),
  q1_left = geraValores(question1__left_side, "1l", desvios),
  #sdq1_left = sd(question1__left_side, na.rm = TRUE),
  q1_right = geraValores(question1__right_side, "1r", desvios),
  #sdq1_right = sd(question1__right_side, na.rm = TRUE),
  q2_left = geraValores(question2__left_side, "2l", desvios),
  #sdq2_left = sd(question2__left_side, na.rm = TRUE),
  q2_right = geraValores(question2__right_side, "2r", desvios),
  #sdq2_right = sd(question2__right_side, na.rm = TRUE),
  q3_left = geraValores(question3__left_side, "3l", desvios),
  #sdq3_left = sd(question3__left_side, na.rm = TRUE),
  q3_right = geraValores(question3__right_side, "3r", desvios)
...
groupedData4 <- summarise(by_image,
  ...
  q1 = geraValores(question1, "1", desvios),
  #sdq1 = sd(question1, na.rm = TRUE),
  q2 = geraValores(question2, "2", desvios)
...
groupedData8 <- summarise(by_image,
  ...
  q2_left = geraValores(question2__left_side, "2l", desvios),
  #sdq2_left = sd(question2__left_side, na.rm = TRUE),
  q2_right = geraValores(question2_right_side, "2r", desvios)
  #sdq2_right = sd(question2__right_side, na.rm = TRUE)  
  )
...
groupedData8 <- renomeiaGrupos(groupedData8, c("q1", "q2_left", "q2_right", "count"), "g8")
...
#temp5 <- merge(temp, groupedData5, by.x="image_url", by.y="image_url")
temp6 <- merge(novosDados, groupedData6, by.x="V2", by.y="image_url")
#temp7 <- merge(temp, groupedData7, by.x="image_url", by.y="image_url")
...
#temp11 <- merge(temp, groupedData11, by.x="image_url", by.y="image_url")
temp12 <- merge(novosDados, groupedData12, by.x="V2", by.y="image_url")
#temp13 <- merge(temp, groupedData13, by.x="image_url", by.y="image_url")

#Correlacao?
calculaCorrelacoes <- function (listaDados, colunaQScore, questao) {
    temp = listaDados[[1]]
    dadosAtuais <- temp[(temp$V1 == questao),] 
    
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g1q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g1q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g1q2_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g1q3, na.action = na.exclude)
    
    temp2 = listaDados[[2]]
    dadosAtuais <- temp2[(temp2$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g2q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g2q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g2q2_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g2q3, na.action = na.exclude)
    
    temp3 = listaDados[[3]]
    dadosAtuais <- temp3[(temp3$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q1_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q1_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q2_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q3_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g3q3_right, na.action = na.exclude)
    
    temp4 = listaDados[[4]]
    dadosAtuais <- temp4[(temp4$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g4q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g4q2, na.action = na.exclude)
    
    temp5 = listaDados[[5]]
    # dadosAtuais <- temp5[(temp5$V1 == questao),] 
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g5q1, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g5q2, na.action = na.exclude)
    
    temp6 = listaDados[[6]]
    dadosAtuais <- temp6[(temp6$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g6q1_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g6q1_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g6q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g6q2_right, na.action = na.exclude)
    
    temp7 = listaDados[[7]]
    # dadosAtuais <- temp7[(temp7$V1 == questao),] 
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g7q1, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g7q2, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g7q3_left, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g7q3_right, na.action = na.exclude)
    
    temp8 = listaDados[[8]]
    dadosAtuais <- temp8[(temp8$V1 == questao),] 
    #cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g8q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g8q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g8q2_right, na.action = na.exclude)
    
    temp9 = listaDados[[9]]
    dadosAtuais <- temp9[(temp9$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g9q1_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g9q1_right, na.action = na.exclude)
    
    temp10 = listaDados[[10]]
    dadosAtuais <- temp10[(temp10$V1 == questao),] 
    #cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g10q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g10q2, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g10q3, na.action = na.exclude)
    
    temp11 = listaDados[[11]]
    # dadosAtuais <- temp11[(temp11$V1 == questao),] 
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g11q2_left, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g11q2_right, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g11q3_left, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g11q3_right, na.action = na.exclude)
    
    temp12 = listaDados[[12]]
    dadosAtuais <- temp12[(temp12$V1 == questao),] 
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g12q1, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g12q2_left, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g12q2_right, na.action = na.exclude)
    cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g12q3, na.action = na.exclude)
    
    temp13 = listaDados[[13]]
    # dadosAtuais <- temp13[(temp13$V1 == questao),] 
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g13q1_left, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g13q1_right, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g13q2_left, na.action = na.exclude)
    # cor.test(dadosAtuais[[colunaQScore]], dadosAtuais$g13q2_right, na.action = na.exclude)
}

sink("correlacao.dat")
print("Agradavel")
calculaCorrelacoes( list(temp, temp2, temp3, temp4, data.frame(), temp6, data.frame(), temp8, temp9, temp10, data.frame(), temp12, data.frame()), "V3.Geral", 'agradavel?')
sink()

agrad <- temp[(temp$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g1q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g1q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g1q2_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g1q3, na.action = na.exclude)

agrad <- temp2[(temp2$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g2q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g2q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g2q2_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g2q3, na.action = na.exclude)

agrad <- temp3[(temp3$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g3q1_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g3q1_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g3q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g3q2_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g3q3_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g3q3_right, na.action = na.exclude)

agrad <- temp4[(temp4$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g4q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g4q2, na.action = na.exclude)

# agrad <- temp5[(temp5$V1 == 'agradavel?'),] 
# cor.test(agrad$V3.Geral, agrad$g5q1, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g5q2, na.action = na.exclude)

agrad <- temp6[(temp6$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g6q1_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g6q1_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g6q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g6q2_right, na.action = na.exclude)

# agrad <- temp7[(temp7$V1 == 'agradavel?'),] 
# cor.test(agrad$V3.Geral, agrad$g7q1, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g7q2, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g7q3_left, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g7q3_right, na.action = na.exclude)

agrad <- temp8[(temp8$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g8q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g8q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g8q2_right, na.action = na.exclude)

agrad <- temp9[(temp9$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g9q1_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g9q1_right, na.action = na.exclude)

agrad <- temp10[(temp10$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g10q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g10q2, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g10q3, na.action = na.exclude)

# agrad <- temp11[(temp11$V1 == 'agradavel?'),] 
# cor.test(agrad$V3.Geral, agrad$g11q2_left, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g11q2_right, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g11q3_left, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g11q3_right, na.action = na.exclude)

agrad <- temp12[(temp12$V1 == 'agradavel?'),] 
cor.test(agrad$V3.Geral, agrad$g12q1, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g12q2_left, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g12q2_right, na.action = na.exclude)
cor.test(agrad$V3.Geral, agrad$g12q3, na.action = na.exclude)

# agrad <- temp13[(temp13$V1 == 'agradavel?'),] 
# cor.test(agrad$V3.Geral, agrad$g13q1_left, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g13q1_right, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g13q2_left, na.action = na.exclude)
# cor.test(agrad$V3.Geral, agrad$g13q2_right, na.action = na.exclude)

print("Segurança")
seg <- temp[(temp$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g1q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g1q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g1q2_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g1q3, na.action = na.exclude)

seg <- temp2[(temp2$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g2q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g2q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g2q2_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g2q3, na.action = na.exclude)

seg <- temp3[(temp3$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g3q1_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g3q1_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g3q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g3q2_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g3q3_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g3q3_right, na.action = na.exclude)

seg <- temp4[(temp4$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g4q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g4q2, na.action = na.exclude)

# seg <- temp5[(temp5$V1 == 'seguro?'),] 
# cor.test(seg$V3.Geral, seg$g5q1, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g5q2, na.action = na.exclude)

seg <- temp6[(temp6$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g6q1_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g6q1_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g6q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g6q2_right, na.action = na.exclude)

# seg <- temp7[(temp7$V1 == 'seguro?'),] 
# cor.test(seg$V3.Geral, seg$g7q1, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g7q2, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g7q3_left, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g7q3_right, na.action = na.exclude)

seg <- temp8[(temp8$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g8q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g8q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g8q2_right, na.action = na.exclude)

seg <- temp9[(temp9$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g9q1_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g9q1_right, na.action = na.exclude)

seg <- temp10[(temp10$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g10q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g10q2, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g10q3, na.action = na.exclude)

# seg <- temp11[(temp11$V1 == 'seguro?'),] 
# cor.test(seg$V3.Geral, seg$g11q2_left, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g11q2_right, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g11q3_left, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g11q3_right, na.action = na.exclude)

seg <- temp12[(temp12$V1 == 'seguro?'),] 
cor.test(seg$V3.Geral, seg$g12q1, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g12q2_left, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g12q2_right, na.action = na.exclude)
cor.test(seg$V3.Geral, seg$g12q3, na.action = na.exclude)

# seg <- temp13[(temp13$V1 == 'seguro?'),] 
# cor.test(seg$V3.Geral, seg$g13q1_left, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g13q1_right, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g13q2_left, na.action = na.exclude)
# cor.test(seg$V3.Geral, seg$g13q2_right, na.action = na.exclude)
sink()
