...
if __name__ == "__main__":
	...
	classifiers_names = ["Nearest Neighbors"] #["Extra Trees", "Nearest Neighbors", "Linear SVM", 
	classifiers = [KNeighborsClassifier(3)]#ExtraTreesClassifier(n_jobs=-1, criterion='entropy'), KNeighborsClassifier(3), SVC(kernel="linear", C=0.025) ]
