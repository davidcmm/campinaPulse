...
#Retestes
```{r , echo=FALSE, warning=FALSE}
aida_old <- read.csv("entrevista/retestes/aida_floriano.csv")
aida_new <- read.csv("entrevista/retestes/aida_floriano2.csv")
kripp.alpha(x=rbind(aida_old$V2, aida_new$V2))
cohen.kappa(cbind(aida_old$V2, aida_new$V2))

mariana_old <- read.csv("entrevista/retestes/mariana_cristina.csv")
mariana_new <- read.csv("entrevista/retestes/mariana_cristina2.csv")
kripp.alpha(x=rbind(mariana_old$V2, mariana_new$V2))
cohen.kappa(cbind(mariana_old$V2, mariana_new$V2))

bea_old <- read.csv("entrevista/retestes/bea_inacio.csv")
bea_new <- read.csv("entrevista/retestes/bea_inacio2.csv")
kripp.alpha(x=rbind(bea_old$V2, bea_new$V2))
cohen.kappa(cbind(bea_old$V2, bea_new$V2))

livia_old <- read.csv("entrevista/retestes/livia_maciel.csv")
livia_new <- read.csv("entrevista/retestes/livia_maciel2.csv")
...
confusionMatrix(method$V2, aida$V2)
print(">>>> Mariana x Surprise")
confusionMatrix(method$V2, mariana$V2)
...
print(">>>> Aida x Surprise")
confusionMatrix(method_modified$V2, spec1$V2)
print(">>>> Mariana x Surprise")
confusionMatrix(method_modified$V2, spec2$V2)
...
confusionMatrix(livia$V2, kainara$V2)
print(">>>> Livia x Surprise")
confusionMatrix( method$V2, livia$V2)
print(">>>> kainara x Surprise")
confusionMatrix( method$V2, kainara$V2)
...
print(">>>> Matriz confusao 2 niveis: 1, (0,-1)")
print(">>>> Livia x Kainara")
confusionMatrix( spec2$V2, spec1$V2)
print(">>>> Livia x Surprise")
confusionMatrix( method_modified$V2, spec1$V2)
print(">>>> Kainara x Surprise")
confusionMatrix( method_modified$V2, spec2$V2)
...
print(">>>> Matriz confusao 3 niveis: 1,0,-1")
print(">>>> Mauro x bea")
confusionMatrix(mauro$V2, bea$V2)
print(">>>> Mauro x Surprise")
confusionMatrix( method$V2, mauro$V2)
print(">>>> bea x Surprise")
confusionMatrix(method$V2, bea$V2)
