...
echo " Geral Agrad x Seg" >> kendall.dat
grep "agrad" first_vote_ordenado.dat > rankingagr1.dat
grep "seg" first_vote_ordenado.dat > rankingseg1.dat
Rscript kendallDistance.R rankingagr1.dat rankingseg1.dat >> kendall.dat 

echo " Cas x Solteiro Agrad" >> kendall.dat
grep "agrad" firsCasadoOrdInter.dat > rankingagr1.dat
grep "agrad" firsSolteiroOrdInter.dat > rankingagr2.dat
Rscript kendallDistance.R rankingagr1.dat rankingagr2.dat >> kendall.dat 

echo " Cas x Solteiro Seg" >> kendall.dat
grep "seg" firsCasadoOrdInter.dat > rankingseg1.dat
grep "seg" firsSolteiroOrdInter.dat > rankingseg2.dat
Rscript kendallDistance.R rankingseg1.dat rankingseg2.dat >> kendall.dat 

echo " Cas Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr1.dat rankingseg1.dat >> kendall.dat
echo " Sol Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr2.dat rankingseg2.dat >> kendall.dat

echo " Baixa x Media Agrad" >> kendall.dat
grep "agrad" firsBaixaOrdInter.dat > rankingagr1.dat
grep "agrad" firsMediaOrdInter.dat > rankingagr2.dat
Rscript kendallDistance.R rankingagr1.dat rankingagr2.dat >> kendall.dat 

echo " Baixa x Media Seg" >> kendall.dat
grep "seg" firsBaixaOrdInter.dat > rankingseg1.dat
grep "seg" firsMediaOrdInter.dat > rankingseg2.dat
Rscript kendallDistance.R rankingseg1.dat rankingseg2.dat >> kendall.dat

echo " Baixa Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr1.dat rankingseg1.dat >> kendall.dat
echo " Media Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr2.dat rankingseg2.dat >> kendall.dat

echo " Fem x Masc Agrad" >> kendall.dat
grep "agrad" firsFemininoOrdInter.dat > rankingagr1.dat
grep "agrad" firsMasculinoOrdInter.dat > rankingagr2.dat
Rscript kendallDistance.R rankingagr1.dat rankingagr2.dat >> kendall.dat 

echo " Fem x Masc Seg" >> kendall.dat
grep "seg" firsFemininoOrdInter.dat > rankingseg1.dat
grep "seg" firsMasculinoOrdInter.dat > rankingseg2.dat
Rscript kendallDistance.R rankingseg1.dat rankingseg2.dat >> kendall.dat

echo " Fem Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr1.dat rankingseg1.dat >> kendall.dat
echo " Masc Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr2.dat rankingseg2.dat >> kendall.dat

echo " Jov x Adu Agrad" >> kendall.dat
grep "agrad" firsJovemOrdInter.dat > rankingagr1.dat
grep "agrad" firsAdultoOrdInter.dat > rankingagr2.dat
Rscript kendallDistance.R rankingagr1.dat rankingagr2.dat >> kendall.dat 

echo " Jov x Adu Seg" >> kendall.dat
grep "seg" firsJovemOrdInter.dat > rankingseg1.dat
grep "seg" firsAdultoOrdInter.dat > rankingseg2.dat
Rscript kendallDistance.R rankingseg1.dat rankingseg2.dat >> kendall.dat

echo " Jov Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr1.dat rankingseg1.dat >> kendall.dat
echo " Adul Agra x Seg" >> kendall.dat
Rscript kendallDistance.R rankingagr2.dat rankingseg2.dat >> kendall.dat

rm rankingagr1.dat rankingagr2.dat rankingseg1.dat rankingseg2.dat
