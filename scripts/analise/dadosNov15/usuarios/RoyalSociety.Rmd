...
test.kendallWithDiffRankingsAndNonZeroDiffFeature <- function(){
   ...
   checkTrue(result['movCarsN'] == 4 / 8)
   checkTrue(result['parkCarsN'] == 6 / 12)
   checkTrue(result['movCiclyN'] == 6 / 12)
   checkTrue(result['buildIdN'] == 6 / 12)
   checkTrue(result['buildNRecN'] == 4 / 8)
   checkTrue(result['treeN'] == 8 / 16)
   checkTrue(result['smallPlaN'] == 4 / 12)
   checkTrue(result['diffBuildN'] == 6 / 12)
   checkTrue(result['streeFurN'] == 6 / 12)
   checkTrue(result['basColN'] == 6 / 12)
   checkTrue(result['lighN'] == 6 / 12)
   checkTrue(result['accenColN'] == 6 / 12)
   checkTrue(result['peopN'] == 6 / 12)
   checkTrue(result['graffN'] == 6 / 12)
   checkTrue(result['buildDiffAgesN'] == 6 / 12)
}
