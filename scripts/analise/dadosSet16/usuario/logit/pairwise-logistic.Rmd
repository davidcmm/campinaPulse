...
text( c(0.4, 0.4, 0.9, 0.9), c(7.75, 7.3, 7.75, 7.3), c("Street width", "Trees", "People", "Moving cars"),  cex=1.2)#Human Scale
text( c(0.4, 0.4, 0.4, 0.9, 0.9), c(6.75, 6.5, 6.3, 6.75, 6.3), c("Trees", "People", "Parked cars", "Ciclysts", "Moving cars"),  cex=1.2)#Complexity
text( 0.7, 5.6, c("Landscape"),  cex=1.2)#Tidiness
text( c(0.4, 0.9), 4.6, c("Trees", "Street width"),  cex=1.2)#Enclosure
text( c(0.4, 0.9), 3.6, c("Buildings ident", "People"),  cex=1.2)#Imageability
text( c(0.4, 0.9), 2.6, c("Street width", "Moving cars"),  cex=1.2)#Linkage
text( 0.7, 1.6, c("People"),  cex=1.2)#Coherence
text( 0.7, 0.6, c("Buildings ident"),  cex=1.2)#Legibility
...
text( c(0.4, 0.4, 0.4, 0.9, 0.9), c(6.75, 6.5, 6.3, 6.75, 6.3), c("Moving cars", "Parked cars", "Trees", "People", "Buildings"),  cex=1.2)#Complexity
text( c(0.4, 0.4, 0.9, 0.9), c(5.75, 5.3, 5.75, 5.3), c("Moving cars", "Trees", "People", "Street width"),  cex=1.2)#Human Scale
text( c(0.4, 0.9), 4.6, c("Moving cars", "Street width"),  cex=1.2)#Linkage
text( 0.7, 3.6, c("Landscape"),  cex=1.2)#Tidiness
text( c(0.4, 0.9), 2.6, c("Trees", "Street width"),  cex=1.2)#Enclosure
text( 0.7, 1.6, c("People"),  cex=1.2)#Imageability
text( 0.7, 0.6, c("People"),  cex=1.2)#Coherence
