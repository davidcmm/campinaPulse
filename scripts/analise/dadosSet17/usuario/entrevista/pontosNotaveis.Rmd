...
show_street_data <- function (current_df, all_data, force_split, highlighted_positive){
    ...
    for(i in 1:nrow(current_df)) {
      ...
      cat("<img src='", photo_name,"' width='300px'>", sep = "")
...
cat("<img src='", as.character(max_point$url),"' width='400px'>", sep = "")
...
cat("<img src='", as.character(min_point$url),"' width='400px'>", sep = "")
...
show_street_data(cristina, all_data, TRUE, highlighted_positive)
...
highlighted_positive <- data.frame(num=c(445, 445, 549, 549, 549, 691, 691, 691, 691, 813, 813, 913, 913), angle=c(22, 112, 22, 112, 203, 22, 293, 112, 203, 112, 293, 112, 203))

show_street_data(floriano, all_data, TRUE, highlighted_positive)
cat("<div class=\"col-xs-12\" style=\"height:300px;\"></div>")
```
