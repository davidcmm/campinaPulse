...
if __name__ == "__main__":
	...
	classifiers_names = ["Linear SVM"] #["Extra Trees", "Nearest Neighbors", "Linear SVM", 
	classifiers = [SVC(kernel="linear", C=0.025)]#ExtraTreesClassifier(n_jobs=-1, criterion='entropy'), KNeighborsClassifier(3), SVC(kernel="linear", C=0.025) ]
