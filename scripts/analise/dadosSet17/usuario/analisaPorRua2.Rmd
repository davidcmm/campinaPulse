...
confusionMatrix(aida$V2, method$V2)
print(">>>> Mariana x Surprise")
confusionMatrix(mariana$V2, method$V2)
...
print(">>>> Aida x Surprise")
confusionMatrix(spec1$V2, method_modified$V2)
print(">>>> Mariana x Surprise")
confusionMatrix(spec2$V2, method_modified$V2)
...
confusionMatrix(livia$V2, method$V2)
print(">>>> kainara x Surprise")
confusionMatrix(kainara$V2, method$V2)
...
confusionMatrix(mauro$V2, method$V2)
print(">>>> bea x Surprise")
confusionMatrix(bea$V2, method$V2)
