...
catoleData$questao <- "Agradável"
centroData$bairro <- "Centro"
centroData$questao <- "Agradável"
liberdadeData$bairro <- "Liberdade"
liberdadeData$questao <- "Agradável"
...
catoleDataSeg$questao <- "Seguro"
centroDataSeg$bairro <- "Centro"
centroDataSeg$questao <- "Seguro"
liberdadeDataSeg$bairro <- "Liberdade"
liberdadeDataSeg$questao <- "Seguro"
