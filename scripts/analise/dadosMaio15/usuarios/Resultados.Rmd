...
texreg(lm(qscore ~ hasYoung + hasOld + hasLowClass + hasMHighClass + hasHighClass + hasMaster + hasPHD + hasMarried + hasDivorced + hasWidower + red + green + blue + diag + vert + hor, data=dadosAgrad))

texreg(lm(qscore ~ hasFemale + hasYoung + hasOld + hasLowClass + hasMHighClass + hasHighClass + hasMaster + hasPHD + hasMarried + hasDivorced + hasWidower + knowsLiberdade + red + green + blue + diag + vert + hor, data=dadosSeg))
```
