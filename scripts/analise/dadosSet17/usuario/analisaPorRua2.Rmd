...
plot_ci_per_photo <- function(data, plotTitle, ids1, ids2){
  ...
  g3 <- ggplot(data, aes(x=num, y=surprise_unif_base, size=3)) + geom_point(aes(colour = surprise_unif_base, shape=side)) + scale_colour_continuous(low="red", high="green") + labs(title = "Uniform + Base Rate") + ylim(c(-0.05, 0.05))
...
surprise_unif_base <- read.csv("./surprise/surprise_unif_base.csv")
```
...
cristina$surprise_unif_base <- melt(filter(surprise_unif_base, street == "R._Cristina_Procópio_Silva"), id.vars = "street")$value
...
edesio$surprise_unif_base <- melt(filter(surprise_unif_base, street == "R._Edésio_Silva"), id.vars = "street")$value
...
inacio$surprise_unif_base <- melt(filter(surprise_unif_base, street == "R._Inácio_Marquês_da_Silva"), id.vars = "street")$value
...
floriano$surprise_unif_base <- melt(filter(surprise_unif_base, street == "Av._Mal._Floriano_Peixoto"), id.vars = "street")$value
...
maciel$surprise_unif_base <- melt(filter(surprise_unif_base, street == "R._Maciel_Pinheiro"), id.vars = "street")$value
...
manoel$surprise_unif_base <- melt(filter(surprise_unif_base, street == "R._Manoel_Pereira_de_Araújo"), id.vars = "street")$value
