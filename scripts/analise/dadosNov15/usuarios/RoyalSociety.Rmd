...
currentData$feature = factor(currentData$feature)
currentData$adjPvalue <- adjustPValues(currentData)
ggplot(data=filter(currentData, adjPvalue < 0.05), aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=10, stroke=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.15, 0.85, 0.15, 0.85), y = c(150, 150, -150, -150), label = c("Evidence of features\ndisliked by high", "Evidence of features\nliked by low", "Evidence of features\nliked by high", "Evidence of features\ndisliked by low"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData$feature = factor(currentData$feature)
currentData$adjPvalue <- adjustPValues(currentData)
ggplot(data=filter(currentData, adjPvalue < 0.05), aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=10, stroke=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.15, 0.85, 0.15, 0.85), y = c(150, 150, -150, -150), label = c("Evidence of features\ndisliked by women", "Evidence of features\nliked by men", "Evidence of features\nliked by women", "Evidence of features\ndisliked by men"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData <- filter(quantileData, grupo == "Jovem_Adulto")
currentData$adjPvalue <- adjustPValues(currentData)
ggplot(data=filter(currentData, adjPvalue < 0.05), aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=10, stroke=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.15, 0.85, 0.15, 0.85), y = c(150, 150, -150, -150), label = c("Evidence of features\ndisliked by adults", "Evidence of features\nliked by young", "Evidence of features\nliked by adults", "Evidence of features\ndisliked by young"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData <- filter(quantileData, grupo == "Casado_Solteiro")
currentData$adjPvalue <- adjustPValues(currentData)
ggplot(data=filter(currentData, adjPvalue < 0.05), aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=10, stroke=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.15, 0.85, 0.15, 0.85), y = c(150, 150, -150, -150), label = c("Evidence of features\ndisliked by single", "Evidence of features\nliked by married", "Evidence of features\nliked by single", "Evidence of features\ndisliked by married"), col = c("red", "green", "green", "red"), size=9)
dev.off()
```
