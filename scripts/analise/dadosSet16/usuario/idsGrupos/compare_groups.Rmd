...
for (folder in c(  "hom60_mul40/" )){
    ...
    for (file in c(paste(folder, "taug_agrad.dat", sep=""), paste(folder, "taug_seg.dat", sep=""))) {
        ...
        }else if(grepl("hom40_mul60", folder) || grepl("hom15_mul60", folder)){
          values <- lapply(as.character(ag_cor$V3), function (x) as.double(str_split(x, pattern = " ")[[1]][12]))       
        }else{
...
itMaxDiffData2 <- read.csv("../gavel/maxdiff_rank_input_woties.dat")
...
```{r read}
for (file in c("../gavel/allPairwiseComparison-gamma01.dat", "../gavel/allPairwiseComparison-gamma5.dat", "../gavel/allPairwiseComparison-gamma20.dat")){
  print(paste(">>>>> Folder ", file))
