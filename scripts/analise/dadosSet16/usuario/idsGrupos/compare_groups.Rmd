...
```{r read}
for (file in c("../all100/all_ordenado.dat-maxdiff")){
...
itMaxDiffData2 <- read.csv("../gavel/maxdiff_rank_input.dat")
...
```{r read}
for (file in c("../gavel/allPairwiseComparison-gamma01.dat", "../gavel/allPairwiseComparison-gamma5.dat", "../gavel/allPairwiseComparison-gamma20.dat", "../gavel/allPairwiseComparison-lam01gam01.dat", "../gavel/allPairwiseComparison-sim.dat")){
  print(paste(">>>>> Folder ", file))
