...
```{r cars}
  masc_files <- list.files(path = "hom15_Mul60/", pattern = "allMasculinoOrdInter*")
  fem_files <- list.files(path = "hom15_Mul60/", pattern = "allFemininoOrdInter*")
  ...
  for (i in seq(1, 100)){
     ...
     men_file <- paste("hom15_Mul60/", masc_files[i], sep="")
     women_file <- paste("hom15_Mul60/", fem_files[i], sep="")
...
for (file in c("hom15_Mul60/tau_mw_agrad.dat", "hom15_Mul60/tau_mw_seg.dat")){
...
```{r cars}
all_diff_m <- list.files(path = "hom15_mul60/", pattern = "allDiffMasFem_*")
...
sink("hom15_mul60/rank_comparisons_general.dat")
for (i in seq(1,100)){
#for (current_file in all_diff_m){
   ...
   current_file <- paste("hom15_mul60/", all_diff_m[i], sep="")
   data <- read.table(current_file)
