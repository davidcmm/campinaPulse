...
livia_new <- read.csv("entrevista/retestes/livia_maciel.csv", header=FALSE)
...
cristina$surprise_unif_base_norm_fixed <- melt(dplyr::filter(surprise_unif_base_norm_fixed_40, street == "R._Cristina_Procópio_Silva"), id.vars = "street")$value
...
inacio$surprise_unif_base_norm_fixed <- melt(dplyr::filter(surprise_unif_base_norm_fixed_40, street == "R._Inácio_Marquês_da_Silva"), id.vars = "street")$value
