...
ggplot(filter(adjr2Data, question == "pleas"), aes(x=quantile, y=adjr2, colour=Groups)) + geom_line(size=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Adj. R2") + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25))
dev.off()

pdf("images/adjr2_Saf.pdf", width = w, height = h)
ggplot(filter(adjr2Data, question == "saf"), aes(x=quantile, y=adjr2, colour=Groups)) + geom_line(size=2) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Adj. R2") + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25))
dev.off()
