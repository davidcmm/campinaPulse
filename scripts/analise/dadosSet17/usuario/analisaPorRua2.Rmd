...
plot_ci_per_photo <- function(data, plotTitle, ids1, ids2){
  ...
  g2 <- ggplot(data, aes(x=num, y=surprise_street, size=3)) + geom_point(aes(colour = surprise_street, shape=side)) + scale_colour_continuous(low="red", high="green") + labs(title = "Uniform for Street") + ylim(c(-0.03, 0.03))
  g3 <- ggplot(data, aes(x=num, y=surprise_num, size=3)) + geom_point(aes(colour = surprise_num, shape=side)) + scale_colour_continuous(low="red", high="green") + labs(title = "Uniform for Num") + ylim(c(-0.1, 0.1))
...
surprise_num <- read.csv("./surprise/surprise_data_num.csv")
```
...
cristina$surprise_street <- melt(filter(surprise_street, street == "R._Cristina_Procópio_Silva"), id.vars = "street")$value
cristina$surprise_num <- melt(filter(surprise_num, street == "R._Cristina_Procópio_Silva"), id.vars = "street")$value
...
edesio$surprise_street <- melt(filter(surprise_street, street == "R._Edésio_Silva"), id.vars = "street")$value
edesio$surprise_num <- melt(filter(surprise_num, street == "R._Edésio_Silva"), id.vars = "street")$value
...
inacio$surprise_street <- melt(filter(surprise_street, street == "R._Inácio_Marquês_da_Silva"), id.vars = "street")$value
inacio$surprise_num <- melt(filter(surprise_num, street == "R._Inácio_Marquês_da_Silva"), id.vars = "street")$value
...
floriano$surprise_street <- melt(filter(surprise_street, street == "Av._Mal._Floriano_Peixoto"), id.vars = "street")$value
floriano$surprise_num <- melt(filter(surprise_num, street == "Av._Mal._Floriano_Peixoto"), id.vars = "street")$value
...
maciel$surprise_street <- melt(filter(surprise_street, street == "R._Maciel_Pinheiro"), id.vars = "street")$value
maciel$surprise_num <- melt(filter(surprise_num, street == "R._Maciel_Pinheiro"), id.vars = "street")$value
...
manoel$surprise_street <- melt(filter(surprise_street, street == "R._Manoel_Pereira_de_Araújo"), id.vars = "street")$value
manoel$surprise_num <- melt(filter(surprise_num, street == "R._Manoel_Pereira_de_Araújo"), id.vars = "street")$value
