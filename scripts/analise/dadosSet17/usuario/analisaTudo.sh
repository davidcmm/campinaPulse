...
cat runOld.csv runNew.csv > run.csv
...
python analisaQScore.py runAdulto.csv 100 tasksDef.csv campina
mv all.dat allAdulto.dat
python analisaQScore.py runJovem.csv 100 tasksDef.csv campina
mv all.dat allJovem.dat
#python analisaQScore.py runMenorMed.csv 100 tasksDef.csv campina
#mv all.dat allMenorMedian.dat
#python analisaQScore.py runMaiorMed.csv 100 tasksDef.csv campina
#mv all.dat allMaiorMedian.dat
python analisaQScore.py runSolteiro.csv 100 tasksDef.csv campina
mv all.dat allSolteiro.dat
python analisaQScore.py runCasado.csv 100 tasksDef.csv campina
mv all.dat allCasado.dat
python analisaQScore.py runMedia.csv 100 tasksDef.csv campina
mv all.dat allMedia.dat
python analisaQScore.py runBaixa.csv 100 tasksDef.csv campina
mv all.dat allBaixa.dat
python analisaQScore.py runFeminino.csv 100  tasksDef.csv campina
mv all.dat allFeminino.dat
python analisaQScore.py runMasculino.csv 100 tasksDef.csv campina
mv all.dat allMasculino.dat
python analisaQScore.py runMedio.csv 100 tasksDef.csv campina
mv all.dat allMedio.dat
python analisaQScore.py runPos.csv 100 tasksDef.csv campina
mv all.dat allPos.dat

python analisaQScore.py runCatole.csv 100 tasksDef.csv
mv all.dat allCatole.dat
python analisaQScore.py runCentro.csv 100 tasksDef.csv
mv all.dat allCentro.dat
python analisaQScore.py runLiberdade.csv 100 tasksDef.csv
mv all.dat allLiberdade.dat
python analisaQScore.py runNotCatole.csv 100 tasksDef.csv
mv all.dat allNotCatole.dat
python analisaQScore.py runNotCentro.csv 100 tasksDef.csv
mv all.dat allNotCentro.dat
python analisaQScore.py runNotLiberdade.csv 100 tasksDef.csv
