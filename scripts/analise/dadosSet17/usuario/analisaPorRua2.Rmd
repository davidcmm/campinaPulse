...
* Descontinuidades no ponto -> Isso tudo pode ser explicado pela regressão geral das features?
...
* Pontos mais heterogeneo/homogeneo: 305 e 436
...
* Descontinuidades no ponto -> o pontos mais heterogêneros foram o 305 (lixo, falta de manutenção) e 436 (falta de manuteção, verde aparente)

* O que é a rua? Rua de mediana para boa, com variações de locais melhores e piores ao longo de toda a rua, no final da rua um lado da rua parece despertar maiores preferências que o outro lado. Dada essa diferença o meio da rua 66 a 261 parece ser a melhor área da rua.
...
* Ponto mais heterogeneo/homogeneo: 70 e 602
...
* Descontinuidades no mesmo lado
+ 70 no side1 -> construção, falta de verde x melhor manutenção, verde
+ 602 no side1 -> falta de manutenção, menos verde aparente x melhor manutenção, verde
+ 602 no side2 -> manutenção, verde x lixão
+ 1136 no side2 -> lixão
* Descontinuidades no ponto: os pontos mais heterogêneos foram o 70 (construção, menor manutenção x melhor manutenção e algum verde) e 602 (menor manutenção, lixão x melhor manutenção, verde)


* O que é a rua? Rua de mediana para boa, com variações de locais melhores e piores ao longo de toda a rua, sem uma distinição clara de melhor área ou lado da rua.
