...
screen(FALSE)
ggplot(catoleData, aes(y=catoleData$V3, x=c("")))+geom_boxplot() + ggtitle(paste(output1))+theme_bw()+ xlab("") + ylab("QScore")
ggplot(centroData, aes(y=centroData$V3, x=c("")))+geom_boxplot() + ggtitle(paste(output2))+theme_bw()+ xlab("") + ylab("QScore")
ggplot(liberdadeData, aes(y=liberdadeData$V3, x=c("")))+geom_boxplot() + ggtitle(paste(output3))+theme_bw()+ xlab("") + ylab("QScore")
