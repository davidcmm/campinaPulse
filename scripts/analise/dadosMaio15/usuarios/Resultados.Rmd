...
print(">>>> Agrad")
regAgrad <- lm(qscore ~ countYoung + countOld + countMale + countMClass + countHighSchool + countGraduated + countMaster + countSingle + countMarried + countKnowsCenter + countKnowsLiberdade + countKnowsCatole + scale(red) + scale(green) + scale(blue) + scale(diag) + scale(vert) + scale(hor) + bairro, data=dadosAgrad)
texreg(regAgrad)

print(">>>> Seg")
regSeg <- lm(qscore ~ countYoung + countOld + countMale + countMClass + countGraduated + countMaster + countSingle + countMarried + countKnowsCenter + countKnowsLiberdade + countKnowsCatole + scale(red) + scale(green) + scale(blue) + scale(diag) + scale(vert) + scale(hor) + bairro, data=dadosSeg)
texreg(regSeg)
