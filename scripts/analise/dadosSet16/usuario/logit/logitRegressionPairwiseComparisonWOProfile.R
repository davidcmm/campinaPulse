...
leaveUserOut <- function(dataFrame){
  ...
  write.table(allAccuracies, file="accuraciesS_WOProfile.dat", row.names=FALSE, quote=FALSE)
  write.table(allPrecision, file="precisionS_WOProfile.dat", row.names=FALSE, quote=FALSE)
  write.table(allRecall, file="recallS_WOProfile.dat", row.names=FALSE, quote=FALSE)
  write.table(cbind(inputFeatures, allPValues), file="pvaluesS_WOProfile.dat", row.names=FALSE, quote=FALSE)
  write.table(cbind(inputFeatures, allCoef), file="coefficientsS_WOProfile.dat", row.names=FALSE, quote=FALSE)
}
