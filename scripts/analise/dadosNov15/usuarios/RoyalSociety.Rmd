...
#Summing features for urban qualities
paste( "Complexity", sum(abs(filter(newTest, (feature == "movCars" | feature == "movCicly" | feature == "parkedCars" | feature == "peop" | feature == "diffBuild" | feature == "buildNRec" | feature == "buildDiffAges" | feature == "ligh" | feature == "graff" | feature == "basCol" | feature == "accenCol" | feature == "streeFur" | feature == "tree" | feature == "smallPla"))$normS)) )

paste( "Human Scale", sum(abs(filter(newTest, (feature == "movCars" | feature == "movCicly" | feature == "peop" |  feature == "ligh" | feature == "streeFur" | feature == "tree" | feature == "smallPla" | feature == "buildHeight" | feature == "longSight" | feature == "streetWid"))$normS)) )

paste( "Imageability", sum(abs(filter(newTest, (feature == "peop" |  feature == "buildId" | feature == "buildNRec" | feature == "basCol" ))$normS)) )

paste( "Enclosure", sum(abs(filter(newTest, (feature == "ligh" |  feature == "tree" | feature == "buildHeight" | feature == "longSight" | feature == "streetWid"))$normS)) )

paste( "Coherence", sum(abs(filter(newTest, (feature == "peop" |  feature == "buildDiffAges" | feature == "ligh" | feature == "basCol" | feature == "accenCol" | feature == "streeFur"))$normS)) )

paste( "Linkage", sum(abs(filter(newTest, (feature == "movCars" |  feature == "longSight" | feature == "streetWid" ))$normS)) )

paste( "Legibility", sum(abs(filter(newTest, (feature == "buildId" |  feature == "longSight" ))$normS)) )

paste( "Transparency", sum(abs(filter(newTest, (feature == "buildHeight" |  feature == "sidewalkWid" ))$normS)) )

paste( "Tidiness", sum(abs(filter(newTest, (feature == "graff" |  feature == "streeFur" | feature == "debris" | feature == "landscape" | feature == "pavement"))$normS)) )
