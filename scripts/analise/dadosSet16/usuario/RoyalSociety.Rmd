...
agradGeral$graffiti <- relevel(agradGeral$graffiti,  "Yes")
segGeral$graffiti <- factor(segGeral$graffiti, levels = c("Yes", "No"))
segGeral$graffiti <- relevel(segGeral$graffiti,  "Yes")
...
regGroup1 <- lm(rank ~ street_wid + mov_cars + park_cars + mov_ciclyst + landscape + build_ident + trees + log2(build_height+1) + people + centro + catole + liberdade + diff_build + graffiti - 1, na.action = na.exclude, data = agradGeral)#Not normalized values
...
regGroup2 <- lm(rank ~  street_wid + mov_cars + park_cars + mov_ciclyst + landscape + build_ident + trees + log2(build_height+1) + people + centro + catole + liberdade + diff_build + graffiti - 1, na.action = na.exclude, data = segGeral)#Not normalized values
...
geral$bairro[geral$bairro == "centro"] <- "City Center"
