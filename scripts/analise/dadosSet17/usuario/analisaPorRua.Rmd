...
show_general_ranking <- function (data){
    top_5 <- head(data2, n=5)
    bottom_5 <- tail(data2, n=5)
...
Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.2 a 2.1 entre ângulos do mesmo número**. Essas diferenças podem ser indicativos de variações de manutenção/qualidade de locais muito próximos. Por exemplo:
...
Para a Edesio percebemos **uma variação de aproximadamente 1.35** nas médias do QScore do número 1136 (terreno, pouco cuidada) e do número 1546 (casas mais novas, bem cuidadas). Esta diferença parece um indicativo de variação entre tipos, ou qualidades, de locais na rua. É importante perceber que, ao contrário da Inacio, a Edesio parece ter uma alternância maior entre locais bem e mal avaliados ao longo da rua.

Analisando os scores de cada ângulo em cada ponto da rua, pode-se observar **que as maiores diferenças variam de 0.24 a 2.4 no QScore entre ângulos do mesmo número**. Por exemplo:
...
+ No número 360, ângulo 90 podemos ter um caso de preferências por fachadas;
...
**as maiores diferenças variam de 0.3 a 1.8 entre ângulos do mesmo número**. Por exemplo:

- No número 370, no ângulo 315 temos aprox. 0.8 a menos do melhor ponto da rua;
- No número 300, ângulo 315 temos aprox. 1.6 a menos  do melhor ponto da rua;
- No número 222, ângulo 22 temos 1.8 a menos do melhor ponto da rua;
