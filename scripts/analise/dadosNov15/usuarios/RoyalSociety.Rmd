...
pdf("images/quantilePlotsMW_Pleas.pdf", width = w, height = h)
...
ggplot(agrad.l, aes(y=diff, x=street_wid)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))#Quantile regression model per quantile and values of diff x feature
ggplot(agrad.l, aes(y=diff, x=mov_cars)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=park_cars)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=mov_ciclyst)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=landscape)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=build_ident)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=trees)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=build_height)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=diff_build)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=people)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(agrad.l, aes(y=diff, x=graffiti)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
dev.off()

#Safety models
seg.l <- seg %>% do(arrange(., V3.Casado)) %>% mutate(rank = 1:n()) %>% do(arrange(., V3.Solteiro)) %>% mutate(index = 1:n())
seg.l$diff <- seg.l$rank - seg.l$index
seg.l$centro <- 0
...
pdf("images/quantilePlotsMS_Saf.pdf", width = w, height = h)
plot(summary(quant1), parm="street_wid")#Coefficients per quantile
plot(summary(quant1), parm="mov_cars")
plot(summary(quant1), parm="park_cars")
plot(summary(quant1), parm="mov_ciclyst")
...
ggplot(seg.l, aes(y=diff, x=street_wid)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))#Quantile regression model per quantile and values of diff x feature
ggplot(seg.l, aes(y=diff, x=mov_cars)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=park_cars)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=mov_ciclyst)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=landscape)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=build_ident)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=trees)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=build_height)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=diff_build)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=people)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
ggplot(seg.l, aes(y=diff, x=graffiti)) + geom_point() + geom_quantile(quantiles = c(0.1, 0.5, 0.9))
dev.off()
