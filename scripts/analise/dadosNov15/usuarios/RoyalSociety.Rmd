...
newAgrad <- head(arrange(head(arrange(agrad, build_ident), n=107), build_height), n=106)
...
summary.rq(quant1, se = "boot", R=400, method="xy")#Pleasantness
...
summary.rq(quant1, se = "boot", R=100000, method="xy")#Safety
