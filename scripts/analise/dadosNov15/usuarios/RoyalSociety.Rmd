...
#dados <- read.table("geralRankAJ.dat", header=TRUE)
...
summary(regAgrad)
texreg(regAgrad)
#regAgrad <- lm(V3 ~ V108 + V110 + V114 + V120 + V121 + V128 + V141 + V144 + V149 + V150 + V162 + V167, data=filter(allUsersData, V1 == "agrad%C3%A1vel?"), na.action = na.exclude)
...
regAgrad <- lm(V3 ~ V108 + V120 + V128 + V140 + V141 + V144 + V149 + V150 + V162 + V167 + ehdVert + ehdHor + ehd45 + ehd135 + ehdNon, data=filter(allUsersData, V1 == "agrad%C3%A1vel?"), na.action = na.exclude)
summary(regAgrad)
...
regSeg <- lm(V3 ~ V105 + V109 + V110 + V114 + V115 + V121 + V131 + V136 + V137 + V140 + V141 + V142 + V144 + V157 + V161 + V162, data=filter(allUsersData, V1 == "seguro?"), na.action = na.exclude)
summary(regSeg)
texreg(regSeg, stars = c(0.1, 0.05, 0.01, 0.001), digits = 6)
regSeg <- lm(V3 ~ V105 + V109 + V110 + V114 + V115 + V121 + V131 + V136 + V137 + V140 + V141 + V142 + V144 + V157 + V161 + V162 + ehdVert + ehdHor + ehd45 + ehd135 + ehdNon, data=filter(allUsersData, V1 == "seguro?"), na.action = na.exclude)
summary(regSeg)
...
#Making ausence of graffiti the variable to not be ploted!
agradGeral <- within(agradGeral, graffiti <- relevel(graffiti, ref = 'Yes'))
segGeral <- within(segGeral, graffiti <- relevel(graffiti, ref = 'Yes'))
...
reg <- lm(V3.Geral ~ red + green + blue, na.action = na.exclude, data = agradGeral)
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
...
#Safety and colors 
reg <- lm(V3.Geral ~ red + green + blue, na.action = na.exclude, data = segGeral)
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
