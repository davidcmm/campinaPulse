...
#Correlation? Spearman and Kendall - non-parametric, any assumption, 
...
calculaCorrelacoes( list(temp, temp2, temp3, temp4, temp5, temp6, temp7, temp8, temp9, temp10, temp11, temp12, temp13), "V3.Geral", "agrad%C3%A1vel?", "correlacao-agrad-kendall.dat")
# 
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Feminino ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
```
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Jovem ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Adulto ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Solteiro ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
```
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Baixa ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
...
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
reg <- regGroup2 <- lm(V3.Media ~ street_wid + sidewalk_wid + mov_cars + park_cars + mov_ciclyst + debris + pavement + landscape + build_ident + build_nrectan + prop_street_wall + prop_wind + long_sight + prop_sky_ahead + prop_sky_across + graffiti + trees + small_planters + build_height + build_diff_ages + diff_build + street_furnit + basic_col + lights + accent_col + people + prop_active_use, na.action = na.exclude, data = filter(res, V1 == "agrad%C3%A1vel?"))
summary(reg)
texreg(reg, stars = c(0.001, 0.01, 0.05, 0.1))
...
```{r, echo=FALSE, fig.show='asis', fig.width=10, fig.height=5}
test <- read.table("teste.dat", header=TRUE)
res <- ggplot(data=test, aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lower, ymax=higher), width=.1)
res + geom_point(data=test, aes(x=feature, y=real), col="red") + ylab("Coeff") + xlab("Feature") + theme(axis.text.x = element_text(angle=60, hjust=1, size=15), axis.text.y=element_text(size=15))

res <- ggplot(data=filter(test, feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight"), aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lower, ymax=higher), width=.1)
res + geom_point(data=filter(test, feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight"), aes(x=feature, y=real), col="red") + ylab("Coeff") + xlab("Feature") + theme(axis.text.x = element_text(angle=60, hjust=1, size=15), axis.text.y=element_text(size=15))

res <- ggplot(data=filter(test, !(feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight")), aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lower, ymax=higher), width=.1) + ylim(c(-1, 1))
res + geom_point(data=filter(test, !(feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight")), aes(x=feature, y=real), col="red") + ylab("Coeff") + xlab("Feature") + theme(axis.text.x = element_text(angle=60, hjust=1, size=15), axis.text.y=element_text(size=15))
  

#Counters
select(arrange(test, -abs(norm)), feature, norm, real)
select(arrange(filter(test, feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight"), -abs(norm)), feature, norm, real)

#Proportions, grades
select(arrange(test, -abs(real)), feature, norm, real)
