...
```{r cars}
#Other groups: "hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "jovem80_adulto80/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/" 
for (folder in c("jovem80_adulto80/")){
    ...
    for (i in seq(1, 100)){
      ...
      #Comparing men random x men original
       ...
       print(paste(">>>>>>> Kendall distance Agrad: Old x Random", g1, normalizedKendallTauDistance2(merged_g1$V3.y, merged_g1$V3.x)))
       res <- cor.test(merged_g1$V3.y, merged_g1$V3.x, method="kendall")
       print(res)
       print(paste(">>>>>>>> Correlation Agrad: Old x Random", g1, res$estimate))
       print(paste(">>>>>>> Kendall distance Seg: Old x Random", g1, normalizedKendallTauDistance2(merged_seg_g1$V3.y, merged_seg_g1$V3.x)))
       res <- cor.test(merged_seg_g1$V3.y, merged_seg_g1$V3.x, method="kendall")
       print(res)
       print(paste(">>>>>>>> Correlation Seg: Old x Random", g1, res$estimate))
...
#Iterating through rank_comparisons files to extract data for tau_agrad and tau_seg: "hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "jovem80_adulto80/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/"
for (folder in c("jovem80_adulto80/")){
    ...
    # sink(paste(folder, "bot10_agrad.dat", sep=""))
    # print(data[index], row.names = FALSE, quote = FALSE)
    # sink()
    # index <- grep(">>>>>>> Set diff Bot10_Seg: Random",  data)
    # sink(paste(folder, "bot10_seg.dat", sep=""))
    # print(data[index], row.names = FALSE, quote = FALSE)
    # sink()
    # 
    # index <- grep( ">>>>>>> Set diff Top10_Agrad: Random",  data)
    # sink(paste(folder, "top10_agrad.dat", sep=""))
    # print(data[index], row.names = FALSE, quote = FALSE)
    # sink()
    # index <- grep(">>>>>>> Set diff Top10_Seg: Random",  data)
    # sink(paste(folder, "top10_seg.dat", sep=""))
    # print(data[index], row.names = FALSE, quote = FALSE)
    # sink()
}
...
for (folder in c("hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "jovem80_adulto80/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/")){
...
for (folder in c("hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "jovem80_adulto80/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/")){
  for ( file in c( paste(folder, "bot10_agrad.dat", sep=""), paste(folder, "top10_agrad.dat", sep=""), paste(folder, "top10_seg.dat", sep=""), paste(folder, "bot10_seg.dat", sep="") ) ){
    ...
    ag_cor$V3 <- as.factor(ag_cor$V3)
    #values <- lapply(as.character(ag_cor$V2), function (x) as.double(str_split(x, pattern = "Random")[[1]][2]))
    values <- lapply(as.character(ag_cor$V3), function (x) as.double(str_split(x, pattern = " ")[[1]][9]))#Column 9 in old format and V2
    new_values <- unlist(lapply(values, '[[', 1))
    ag_cor$value <- new_values
