...
res <- ggplot(data=test, aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lowerSid, ymax=higherSid), width=.1)
...
res <- ggplot(data=filter(test, feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight"), aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lowerSid, ymax=higherSid), width=.1)
...
res <- ggplot(data=filter(test, !(feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight")), aes(x=feature, y=random), col="red", ylab="Coeff", xlab="Feature") + geom_point() + geom_errorbar(aes(ymin=lowerSid, ymax=higherSid), width=.1) + ylim(c(-1, 1))
res + geom_point(data=filter(test, !(feature == "streetWid" | feature == "sidewalkWid" | feature == "longSight" | feature == "buildHeight")), aes(x=feature, y=real), col="red") + ylab("Coeff") + xlab("Feature") + theme(axis.text.x = element_text(angle=60, hjust=1, size=15), axis.text.y=element_text(size=15))
