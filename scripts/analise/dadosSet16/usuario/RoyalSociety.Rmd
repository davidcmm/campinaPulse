...
allUsersData <- merge(allUsersData, agrad, by.x = "V2", by.y = "image_url")
...
regAgrad <- lm(landscape ~ V108 + V128 + V140 + V144 + V149 + V150 + V162 + V167, data=filter(allUsersData, V1.x == "agrad%C3%A1vel?"), na.action = na.exclude)#Separate diagonals
summary(regAgrad)
sink()
