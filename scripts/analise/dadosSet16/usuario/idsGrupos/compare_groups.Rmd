...
```{r cars}
#Other groups: "hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/" 
for (folder in c("hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/")){
...
#        print(paste(">>>>>>>> Correlation Seg: Random", g1, "x", g2, res$estimate))
       ...
       merged <- merge(head(ag_g1, n=10), head(ag_g2, n=10), by.x="V2", by.y="V2")
       merged_seg <- merge(head(seg_g1, n=10), head(seg_g2, n=10), by.x="V2", by.y="V2")
       

       print(paste(">>>>>>> Set diff Top10_Agrad: Random", g1, "x", g2, length(setdiff(head(ag_g1, n=10)$V2, head(ag_g2, n=10)$V2))))
      print(paste(">>>>>>> Set diff Top10_Agrad: Random",  g2, "x", g1, length(setdiff(head(ag_g2, n=10)$V2, head(ag_g1, n=10)$V2))))
       ...
       print(paste(">>>>>>>> Correlation Top10_Agrad: Random", g1, "x", g2, res$estimate))
        ...
        print(paste(">>>>>>> Set diff Top10_Seg: Random", g1, "x", g2, length(setdiff(head(seg_g1, n=10)$V2, head(ag_g2, n=10)$V2))))
      print(paste(">>>>>>> Set diff Top10_Seg: Random",  g2, "x", g1, length(setdiff(head(ag_g2, n=10)$V2, head(seg_g1, n=10)$V2))))
      ...
      print(paste(">>>>>>> Set diff Bot10_Agrad: Random", g1, "x", g2, length(setdiff(tail(ag_g1, n=10)$V2, tail(ag_g2, n=10)$V2))))
      print(paste(">>>>>>> Set diff Bot10_Agrad: Random",  g2, "x", g1, length(setdiff(tail(ag_g2, n=10)$V2, tail(ag_g1, n=10)$V2))))
       ...
       print(paste(">>>>>>>> Correlation Bot10_Agrad: Random", g1, "x", g2, res$estimate))
        ...
        print(paste(">>>>>>> Set diff Bot10_Seg: Random", g1, "x", g2, length(setdiff(tail(seg_g1, n=10)$V2, tail(seg_g2, n=10)$V2))))
      print(paste(">>>>>>> Set diff Bot10_Seg: Random",  g2, "x", g1, length(setdiff(tail(seg_g2, n=10)$V2, tail(seg_g1, n=10)$V2))))
...
#Iterating through rank_comparisons files to extract data for tau_agrad and tau_seg: "hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/"
for (folder in c("hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/")){
    ...
    sink(paste(folder, "taut10_agrad.dat", sep=""))
    print(data[index], row.names = FALSE, quote = FALSE)
    sink()
    
    index <- grep( ">>>>>>>> Correlation Bot10_Agrad: Random",  data)
    sink(paste(folder, "taub10_agrad.dat", sep=""))
    print(data[index], row.names = FALSE, quote = FALSE)
    sink()
    
    index <- grep( ">>>>>>>> Correlation Top10_Seg: Random",  data)
    sink(paste(folder, "taut10_seg.dat", sep=""))
    print(data[index], row.names = FALSE, quote = FALSE)
    sink()
    
    index <- grep( ">>>>>>>> Correlation Bot10_Seg: Random",  data)
    sink(paste(folder, "taub10_seg.dat", sep=""))
    print(data[index], row.names = FALSE, quote = FALSE)
    sink()
}
...
for (folder in c("hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "hom60_mul15/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/")){
  ...
  for ( file in c(paste(folder, "tau_agrad.dat", sep=""), paste(folder, "tau_seg.dat", sep=""), paste(folder, "taut10_agrad.dat", sep=""), paste(folder, "taut10_seg.dat", sep=""), paste(folder, "taub10_agrad.dat", sep=""), paste(folder, "taub10_agrad.dat", sep="")) ) {
...
#Other groups: "hom15_mul60/", "hom40_mul60/", "hom95_mul95/", "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/"
for (folder in c("hom60_mul15/")){
...
#, "jovem15_adulto60/", "jovem40_adulto60/", "jovem60_adulto15/", "jovem60_adulto40/", "media15_baixa60/", "media40_baixa60/", "media60_baixa15/", "media60_baixa40/"
for (folder in c("hom60_mul15/")){
