...
if __name__ == "__main__":
	...
	classifiers_names = ["Linear SVM"]#, "Nearest Neighbors", "RBF SVM", "Naive Bayes", "Linear SVM"]
	
	if phase == 'train-config':

		classifiers = [SVC(kernel="linear", C=0.025)]#, KNeighborsClassifier(3), SVC(kernel="linear", C=0.025), SVC(gamma=2, C=1), GaussianNB()]
