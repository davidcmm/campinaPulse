...
users_n_answered <- read.table("../backupBanco/usersNAnswered.dat")
...
not_answered <- merge(select(users_n_answered, V1), select(users_profile, V1, V3, V5), by.x = "V1", by.y = "V1")
View(not_answered)
```
...
print(dif)
print(qchisq(0.95, df=5))
print(qchisq(0.99, df=5))
