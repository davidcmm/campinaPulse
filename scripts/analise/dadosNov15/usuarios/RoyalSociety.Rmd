...
seg.l <- seg %>% do(arrange(., V3.Casado)) %>% 
    mutate(rank = 1:n()) %>% do(arrange(., V3.Solteiro)) %>% mutate(index = 1:n())
seg.l$diff <- seg.l$rank - seg.l$index
head(select(arrange(seg.l, desc(abs(diff))), rank, index, diff, image_url, V3.Casado, V3.Solteiro), n=20)
...
quantileData$feature[quantileData$feature == "build_ident"] <- "Buildings with Identifiers"
quantileData$feature[quantileData$feature == "graffiti"] <- "Graffiti"
quantileData$feature[quantileData$feature == "people"] <- "People"

#Fixing shapes
shapes <- c(1:14)
names(shapes) <- c("Center Neig", "Catolé Neig", "Liberdade Neig", "Street Width", "Building Height", "Maintenance", "Moving Cars", "Parked Cars", "Moving Ciclysts", "Trees", "Different Buildings", "Buildings with Identifiers", "Graffiti", "People")
...
ggplot(data=currentData, aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=12, stroke=5) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.1, 0.9, 0.1, 0.9), y = c(150, 150, -150, -150), label = c("Less of the features \n are better for Adults", "More of the features \n are better for Young", "More of the features \n are better for Adults", "Less of the features \n are better for Young"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData$feature = factor(currentData$feature)
ggplot(data=currentData, aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=12, stroke=5) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.1, 0.9, 0.1, 0.9), y = c(150, 150, -150, -150), label = c("Less of the features \n are better for High", "More of the features \n are better for Low", "More of the features \n are better for High", "Less of the features \n are better for Low"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData <- filter(quantileData, grupo == "Baixa_Media")
ggplot(data=currentData, aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=12, stroke=5) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.1, 0.7, 0.1, 0.7), y = c(150, 150, -150, -150), label = c("Less of the features \n are better for High", "More of the features \n are better for Low", "More of the features \n are better for High", "Less of the features \n are better for Low"), col = c("red", "green", "green", "red"), size=9)
dev.off()
...
currentData <- filter(quantileData, grupo == "Casado_Solteiro")
ggplot(data=currentData, aes(x=quantile, y=value, colour=feature, label=feature, shape=feature)) + scale_shape_manual(values=shapes[c(as.character(currentData$feature))]) + scale_color_manual(values=colors[c(as.character(currentData$feature))]) + geom_point(alpha = 0.7, size=12, stroke=5) + theme_bw() + theme_classic() + xlab("Quantile") + ylab("Coefficient Values") + scale_y_continuous(limit = c(-180, 180), breaks = c(-180, -150, -120, -90, -60, -30, 0, 30, 60, 90, 120, 150, 180)) + scale_x_continuous(limit = c(0, 1), breaks = c(0.1, 0.3, 0.5, 0.7, 0.9)) + theme(axis.line = element_blank(), axis.text=element_text(size=25), axis.title=element_text(size=25), legend.text = element_text(size=25), legend.title = element_text(size=25)) + geom_abline(intercept=0, col="black") + geom_vline(xintercept = 0.5, col="black") + annotate("text", x = c(0.1, 0.7, 0.1, 0.7), y = c(150, 150, -150, -150), label = c("Less of the features \n are better for Single", "More of the features \n are better for Married", "More of the features \n are better for Single", "Less of the features \n are better for Married"), col = c("red", "green", "green", "red"), size=9)
dev.off()
```
