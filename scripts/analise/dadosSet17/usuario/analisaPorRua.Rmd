...
1. A coleta nos artigos gera uma pergunta, e o detalhamento da rua? Ao escolhermos pontos tão esparsos estamos considerando a média dos ambientes?
...
Abaixo temos, primeiramente, uma análise, para determinar o tamanho da amostra para 95% de confiança. Em seguida, temos a comparação do ranking geral da amostra atual contendo 286 pessoas (113 pessoas que não são de Campina e 140 que são daqui), com a amostra de 29 usuários (primeira amostra analisada) e com a amostra de 69 pessoas (sendo todos moradores de Campina).
...
Feita a seleção de quem é morador e não morador de Campina temos, atualmente, 140 moradores e 113 não moradores. **Quão parecido é o ranking geral de moradores e não moradores?**
...
Após a análise das médias por rua e de suas desigualdades, vamos dar uma olhada geral ao longo de todas as ruas sob a visão de todos os usuários, só dos moradores e só dos não moradores
